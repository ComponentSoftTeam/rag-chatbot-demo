...
with gr.Blocks(title="CompSoft") as demo:
    ...
    gr.Markdown("# Magyar Telekom 5G RAG Demo")
    ...
    with gr.Row():
        chatbot=gr.Chatbot(label="ComponentSoft_5G_RAG", height=400, show_copy_button=True)
    with gr.Row():
...
#demo.launch()
demo.launch(share=True, share_server_address="gradio.componentsoft.ai:7000", share_server_protocol="https", auth=("Telekom", "Könyveskrt36"), max_threads=20, show_error=True, favicon_path="data/favicon.ico", state_session_capacity=20)
